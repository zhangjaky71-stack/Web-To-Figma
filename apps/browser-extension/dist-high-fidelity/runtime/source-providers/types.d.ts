export declare const SOURCE_PROVIDERS_VERSION: "1.0.0";
...
export type SourceReferenceKind = "network" | "file" | "local-folder" | "inline" | "blob" | "unsupported";
export interface SourceCapability {
    provider: SourceProviderKind;
    supported: boolean;
    available: boolean;
    code: "ready" | "unsupported-scheme" | "file-scheme-access-disabled" | "missing-local-folder-selection" | "invalid-local-folder-selection";
    reason: string;
